...
def main(config):
    ...
    torch.save(model.state_dict(), "PDE-burgers-FNO.pt")
    print("Model saved → PDE-burgers-FNO.pt")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("loss-PDE-burgers-FNO.png", dpi=300)
    plt.close()
    print("Loss curves saved → loss-PDE-burgers-FNO.png")
