...
def main(config):
    ...
    torch.save(model.state_dict(), "PDE-burgers-v-001-256-128-FNO.pt")
    print("Model saved → PDE-burgers-v-001-256-128-FNO.pt")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("loss-PDE-burgers-v-001-256-128-FNO.png", dpi=300)
    plt.close()
    print("Loss curves saved → loss-PDE-burgers-v-001-256-128-FNO.png")
