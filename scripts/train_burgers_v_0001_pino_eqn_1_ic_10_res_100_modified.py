...
equation_loss = BurgersEqnLoss(
    method=config.opt.get("pino_method", "fdm"), visc=0.001, loss=F.mse_loss
)
...
# -----------------------------
torch.save(model.state_dict(), "pino_burgers_v_0001_last_model_eqn_1_ic_10_res_100_modified.pt")
print("Saved final model to pino_burgers_v_0001_last_model_eqn_1_ic_10_res_100_modified.pt")
...
with open("pino_burgers_v_0001_losses_eqn_1_ic_10_res_100_modified.json", "w") as f:
    json.dump(loss_data_clean, f, indent=2)

print("Saved train/test losses → pino_burgers_v_0001_losses_eqn_1_ic_10_res_100_modified.json")
...
plt.tight_layout()
plt.savefig("loss_curve_burgers_v_0001_eqn_1_ic_10_res_100_modified.png", dpi=300)
plt.close()


print("Saved loss curve → loss_curve_burgers_v_0001_eqn_1_ic_10_res_100_modified.png")
...
plt.grid(True, which="both")  # <-- optional: show grid for log ticks
plt.tight_layout()
plt.savefig("loss_curve_equation_ic_burgers_v_0001_eqn_1_ic_10_res_100_modified.png", dpi=300)
plt.close()