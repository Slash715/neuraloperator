...
# -----------------------------
torch.save(model.state_dict(), "pino_burgers_last_model_001.pt")
print("Saved final model to pino_burgers_last_model_001.pt")
...
with open("pino_burgers_losses_001.json", "w") as f:
    json.dump(loss_data_clean, f, indent=2)

print("Saved train/test losses → pino_burgers_losses_001.json")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("loss_curve_001.png", dpi=300)
plt.close()


print("Saved loss curve → loss_curve_001.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("loss_curve_equation_ic_001.png", dpi=300)
plt.close()
